 ...
 function datePicker(options = {}) {
     ...
     const confirmTime = e => {
         ...
         localStorage.yhTime = `${year}-${month}-${day} ${hour}:${minute}`;
         console.log(year, month, day, hour, minute, timeStamp, timeStr)
         document.querySelector('.mf-picker').style.top = '100%';
     }
     ...
     const toggle = e => {
         e.preventDefault()
         e.stopPropagation()
         if (e.currentTarget.className === 'cancel') document.querySelector('.mf-picker').style.top = '100%';
     }
