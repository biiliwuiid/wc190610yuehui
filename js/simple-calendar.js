...
class SimpleCalendar {
  ...
  create() {
    ...
    header.innerHTML = header.innerHTML + '<div class="sc-actions">' +  '    <select class="sc-select-month" name="">' + '    </select>'  + '</div>';
    header.innerHTML = header.innerHTML + '    <div class="sc-mleft">' + '      &lsaquo;</div>' + '<div class="sc-year">'+ nYear + '年' + nMonth + '月</div>' + '    <div class="sc-mright">&rsaquo;</div>' + '</div>';
  ...
  updateEvent() {
    ...
    daysElement.forEach(function (v, i) {
      ...
      v.onclick = function () {
        ...
        if (typeof calendar._options.onClick === 'function') {
          calendar._options.onClick(calendar.getSelectedDay());
        }
      };
    });
    ...
    var yearText = container.querySelector('.sc-year');
    ...
    monthadd.onclick = function () {
      if (selectMonth.value > new Date().getMonth() + 1) return;
      ...
      yearText.innerHTML = currentyear + '年' + currentmonth + '月';
