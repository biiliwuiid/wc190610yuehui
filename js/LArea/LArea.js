    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.innerHTML = '<div class="selectHaze"></div><div class="area_ctrl slideInUp">' +
                ...
                var selectHaze_cancel = _self.gearArea.querySelector(".selectHaze");
                selectHaze_cancel.addEventListener('touchstart', function(e) {
                    _self.close(e);
                });
        ...
        finish: function(e) {
            ...
            if (_self.trigger.tagName === 'INPUT' || _self.trigger.tagName === 'TEXTAREA') {
